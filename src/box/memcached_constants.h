...
struct memcached_get_ext {
	uint32_t flags;
};

struct memcached_set_ext {
	uint32_t flags;
	uint32_t expire;
};

struct memcached_delta_ext {
	uint64_t delta;
	uint64_t initial;
	uint32_t expire;
};

struct memcached_flush_ext {
	uint32_t expire;
};

struct memcached_verb_ext {
	uint32_t verbosity;
};

struct memcached_touch_ext {
	uint32_t expire;
};
